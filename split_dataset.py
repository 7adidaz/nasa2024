...
parser.add_argument("--train", type=int, default=70, help="Percentage of train set")
parser.add_argument("--validation", type=int, default=15, help="Percentage of validation set")
parser.add_argument("--test", type=int, default=15, help="Percentage of test set")
parser.add_argument("--folder", type=str, default="Dataset", help="Folder that contain image")
